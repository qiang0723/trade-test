...
class StopLossService:
    ...
    # 默认配置（基于2026-01-30回测优化 v2）
    # 全局最优参数：止损0.8%，止盈1.6%（盈亏比2.0:1），预期收益+0.387%/笔
    # TREND环境最优：止损1.5%，盈亏比2.5:1，预期收益+0.553%/笔
    CONFIG = {
        # 止损倍数（相对于波动率）
        ...
        'take_profit_multiplier': {
            'trend': 2.5,      # TREND环境：盈亏比2.5:1（回测最优）
        ...
        'max_stop_loss_pct': 0.015,   # 最大止损 1.5%（TREND最优）
